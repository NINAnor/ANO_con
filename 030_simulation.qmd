...
Based on the above, and with the help of ChatGPT [version 5), I created a function `nested_balanced` in a new package [spaceR](https://ninanor.github.io/spaceR/). We can install the package like this:

```{r}
remotes::install_github("NINAnor/spaceR")
library(spaceR)
?nested_balanced
```
