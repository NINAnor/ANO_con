...
This web documents the sampling procedure for ANO modules, especially ANO wetlands (ANO våtmark). We also  show you how to connect to the internal NINA postgreSQL database containing the spatial data for the ANO-modules. 
