# Bioclimatic regions from Bakkestuen et al 2008 {#sec-bio1}
...
This custom map will be used for stratifying the samples, i.e. give them equal importance in the sampling. 
